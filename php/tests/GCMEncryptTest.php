...
class GCMEncryptTest extends PHPUnit_Framework_TestCase
{
	...
	"transaction": {
        ...
        print_r("\n-------------------------------------------------------\n");
        try {
            $sdkClient = new  SdkClient(Environment::DEV, '29veq40t2o09kosv9el08avgjn', 'upsk36p3des36b5frb502fmj4mitim37a5gstkdht57j24afcii', "msec/genKey wscobroairlines/pymtAgenciesNoDates");
